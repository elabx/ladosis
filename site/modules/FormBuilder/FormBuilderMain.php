...
class FormBuilderMain implements IteratorAggregate, Countable {
	 ...
	 *
	 */
	const RCD = 'ProcessWire Form Builder - Copyright 2016 by Ryan Cramer Design, LLC';
	 ...
	 * 
	 * @var WireDatabasePDO|ProcessWire\WireDatabasePDO
	 *
	 */
	protected $database;
	 ...
	 *
	 * @param string $key
	 * @return WireDatabasePDO|ProcessWire\WireDatabasePDO|null
	 * 
	 */
	 ...
	 * 
	 * @return PDO|\ProcessWire\WireDatabasePDO|WireDatabasePDO
	 * 
	 */
