...
class FormBuilderFrameworkUikit extends FormBuilderFramework {
	...
	public function load() {
		...
		if($this->allowLoad('framework')) {
			...
			if($this->allowLoad('uk-form-advanced', false)) {
				
				if($ukPath && file_exists("$ukPath/css/components/form-advanced.$ukTheme")) {
					$config->styles->append("$ukURL/css/components/form-advanced.$ukTheme");
				} else {
					$config->styles->append("$ukURL/css/components/form-advanced.min.css");
				}
			}
			if($this->allowLoad('uk-form-select', false)) {
				if($ukPath && file_exists("$ukPath/css/components/form-select.$ukTheme")) {
					$config->styles->append("$ukURL/css/components/form-select.$ukTheme");
				} else {
					$config->styles->append("$ukURL/css/components/form-select.min.css");
				}
