...
class MediaManager extends WireData {
	...
	/**
	 * Set a value to the media-manager: row, column, value
	 *
	 */
	 ...
	 *
	 * @access public
	 * @param $mediaPage Page An image media page where the image is saved.
	 * @param $version Int denoting version number of the image as assigned by ProcessWire.
	 * @return $image Object The image object.
	 *
	 */
	 ...
	 *
	 * @access public
	 * @return $out String HTML5 Markup string of audio media.
	 *
	 */
	public function renderMediaAudio($media, $title) {

		$out = '';
		if(!count($media)) return $out;
		...
		$out = "<div class='mm_render_audio_player'>" .
					"<span>" . $title . "</span>" .
	 ...
	 *
	 * @access public
	 * @return $out String Markup string for document media.
	 *
	 */
	 ...
	 *
	 * @access public
	 * @return $out String Markup string of image media.
	 *
	 */
	 ...
	 *
	 * @access public
	 * @return $out String HTML5 Markup string of video media.
	 *
	 */
	public function renderMediaVideo($media, $title) {
		...
		$out = "<div class='mm_render_video_player'>" .
					"<span>" . $title . "</span>" .
